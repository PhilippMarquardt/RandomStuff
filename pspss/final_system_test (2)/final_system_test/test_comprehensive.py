...
def load_test_data():
    ...
    with open('comprehensive_test_data.json', 'r') as f:
        return json.load(f)
...
def test_2004_exclude_class_positions():
    ...
    print("  Removed positions: pos_6 (class=true)")
    print("  Kept: pos_1, pos_2, pos_3, pos_4, pos_5, pos_7, pos_8, pos_9, pos_10")
    ...
    expected_pos = ['pos_1', 'pos_2', 'pos_3', 'pos_4', 'pos_5', 'pos_7', 'pos_8', 'pos_9', 'pos_10']
...
def test_2007_modifier_override():
    ...
    print("    Keeps positions: pos_1, pos_6, pos_10")
    ...
    expected_pos = ['pos_1', 'pos_6', 'pos_10']
...
def main():
    ...
    engine = FastPerspectiveEngine('comprehensive_rules.json')
