...
export default function PDFComparePage() {
  ...
  const [systemPrompt, setSystemPrompt] = useState('You are an expert document analyst. For all pdfs uploaded find the same sections in all documents and show the differences in form of markdown tables if possible');
